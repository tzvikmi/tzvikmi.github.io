...
/* harmony import */ var _x2one_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @x2one/core */ "./node_modules/@x2one/core/fesm2015/x2one-core.js");
/* harmony import */ var _x2one_models__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @x2one/models */ "./node_modules/@x2one/models/fesm2015/x2one-models.js");
/* harmony import */ var _x2one_common__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @x2one/common */ "./node_modules/@x2one/common/fesm2015/x2one-common.js");
...
const X21ServiceHost = "http://0.0.0.0:3000";
const X21AuthHost = "http://0.0.0.0:3005";
const HE_LOCALIZATIONS = {
    code: "HE",
    name: "עברית",
    direction: "rtl",
    translations: {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _x2one_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @x2one/core */ "./node_modules/@x2one/core/fesm2015/x2one-core.js");
...
let ManageNumbersComponent = class ManageNumbersComponent {
    constructor(dispatcher, _snackBar) {
    ...
    addNumber() {
        if (this.validateNumber()) {
            this.dispatcher.dispatch('http://0.0.0.0:3000/api/v1/number_list/add', this.options).subscribe((response) => {
                this.setStatus("!המספר נוסף בהצלחה");
                this.clear();
            }, (error) => {
                console.log(error);
                this.setStatus("בעיה בהוספת המספר");
            });
        }
    }
    clear() {
    ...
    search(active = false) {
        if (this.validateNumber()) {
            this.dispatcher.dispatch('http://0.0.0.0:3000/api/v1/number_list/get', this.options).subscribe((response) => {
                this.data = response.data('data');
            }, (error) => {
                console.log(error);
                this.setStatus("בעיה בחיפוש");
            });
        }
    }
    checkNumber() {
        if (this.validateNumber()) {
            this.dispatcher.dispatch('http://0.0.0.0:3000/api/v1/number_list/check_number', this.options).subscribe((response) => {
                this.data = response.data('data');
                if (this.data.length < 1) {
                    this.data.push({ number: this.options["number"], active: true, outgoing_calls: true, incoming_calls: true, incoming_sms: true, outgoing_sms: true });
                }
            }, (error) => {
                console.log(error);
                this.setStatus("בעיה בבדיקה");
            });
        }
    }
};
